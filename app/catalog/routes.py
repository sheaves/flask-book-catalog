...
"""
@main.route('/')    # use blueprint to route, instead of app (no longer available at global level)
def hello():
    return 'hello world'
"""
...
def edit_book(book_id):
    book = Book.query.get(book_id)
    form = EditBookForm(obj=book)   # pre-populates the form with existing data
...
def create_book(pub_id):
    form = CreateBookForm()
    form.pub_id.data = pub_id   # pre-populates pub_id into our form
